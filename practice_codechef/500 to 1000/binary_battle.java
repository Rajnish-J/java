...
In one round, each team will be paired up with and compete against one of the other teams. If there are X teams before the start of a round, X/2
​matches are held simultaneously during the round between X/2 pairs of teams. 
